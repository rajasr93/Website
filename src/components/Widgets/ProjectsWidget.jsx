    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {data.map((project, i) => (
          <div
            key={i}
            className="group flex flex-col p-6 bg-white/50 border border-slate-200 hover:border-purple-500/50 rounded-2xl transition-all duration-300 hover:bg-white hover:shadow-xl hover:-translate-y-1"
          >
