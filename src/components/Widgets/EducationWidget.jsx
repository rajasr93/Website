    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="grid gap-4">
        {data.map((edu, i) => (
          <div 
            key={i} 
            className="flex flex-col sm:flex-row gap-5 p-6 bg-slate-900/50 border border-white/10 rounded-2xl hover:border-emerald-500/30 transition-colors"
          >
            ...
            <div className="flex-grow">
              ...
              <div className="text-lg text-emerald-400 font-medium mt-1">{edu.degree}</div>
